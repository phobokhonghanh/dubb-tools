...
class PipelineView(BaseFeatureView):
    ...
    def _sync_controls(self) -> None:
        ...
        controls["merge_override_column"].visible = first_step == "merge"
    ...
    def build(self, page: ft.Page) -> ft.Control:
        ...
        def ui_progress(progress: PipelineProgress) -> None:
            ...
            if status:
                ...
                status.percent = progress.overall_percent
            request_ui_refresh()
                ...
                controls=[
                    ...
                    ft.Container(
                        ...
                        content=ft.Column(
                            spacing=12,
                            controls=[
                                ft.Row([ft.Icon(ft.Icons.SETTINGS, color=ACCENT), ft.Text("Cấu hình nhanh", size=18, weight=ft.FontWeight.BOLD)]),
                                ft.Row([stt_model_dropdown, stt_language_dropdown], spacing=12),
                                ft.Row([translate_model_field, translate_target_dropdown, translate_api_key_field, translate_safety_checkbox], spacing=12),
                                ft.Row([tts_provider_dropdown, tts_language_dropdown, tts_voice_dropdown], spacing=12),
                                ft.Row([tts_api_key_field], spacing=12),
                                ft.Row([ft.Text("Tốc độ TTS", width=120), tts_rate_value, tts_rate_slider], spacing=12),
                                ft.Row([ft.Text("Âm lượng TTS", width=120), tts_volume_value, tts_volume_slider], spacing=12),
                    ...
                    ft.Container(
                        ...
                        content=ft.Column(
                            ...
                            controls=[
                                ...
                                progress_label,
                                status_text,
                                ft.Row([start_button, stop_button, open_job_button], spacing=12),
                            ],
                        ),
                    ),
                    ft.Row(
